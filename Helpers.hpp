...
namespace ECE141 {
  ...
  static std::map<std::string,  Keywords> gDictionary = {
    ...
    std::make_pair("script",    ECE141::Keywords::script_kw),
  ...
  static DataTypes keywordToDataTypes(Keywords aType) {
      switch(aType) {
    ...
    static Logical operatorToLogical(Operators op) {
      switch(op){
        case Operators::and_op  : return Logical::and_op;
        case Operators::or_op   : return Logical::or_op;
        case Operators::not_op  : return Logical::not_op;
